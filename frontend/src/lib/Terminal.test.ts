...
describe("Terminal reconnect", () => {
  ...
  it("reconnects immediately after a visible-tab socket close", () => {
    render(Terminal, { props: { selection: { kind: "worktree" as const, branch: "feature/reconnect" }, terminalTheme: getTheme("github-dark").terminal } });
  ...
  it("only retries once automatically for a visible-tab close", () => {
    render(Terminal, { props: { selection: { kind: "worktree" as const, branch: "feature/retry-once" }, terminalTheme: getTheme("github-dark").terminal } });
  ...
  it("waits for the tab to become visible before reconnecting hidden closes", () => {
    render(Terminal, { props: { selection: { kind: "worktree" as const, branch: "feature/visible" }, terminalTheme: getTheme("github-dark").terminal } });
  ...
  it("applies theme updates to the terminal instance", async () => {
    ...
    const rendered = render(Terminal, {
      props: {
        selection: { kind: "worktree" as const, branch: "feature/theme" },
